  ...
  return (
    <Container maxW="container.md">
      <Box paddingTop={"10"} paddingBottom={"10"}>
        ...
        >
          <Box>
            ...
            <Text
              ...
              paddingTop={"5"}
            >
              A try-hard web developer from the Philippines. With{" "}
              {differenceInCalendarYears(new Date(), new Date(2018, 9, 1))}{" "}
              years experience in developing applications. I enjoy building
              applications from scratch, Willing to take on any challenge even
              with little knowledge about. And learning along the process.
            </Text>
            ...
            <Text
              ...
              color={useColorModeValue("gray.700", "gray.500")}
            >
              While you&apos;re here let me know you dropped by.{" "}
              <NextLink href="/guestbook">
                <Link fontWeight="bold" color="blue.400">
                  Guest book
                </Link>
              </NextLink>
            </Text>
            ...
            <Flex paddingTop="5" paddingBottom="5">
              ...
              <NextLink
                href="https://www.linkedin.com/in/bevan-tony-medrano-544151179/"
                passHref
              >
                <a target="_blank">
          ...
          <Accordion allowMultiple className={style.accordionContainer}>
              ...
              <AccordionButton _expanded={{ bg: "blue.200", color: "black" }}>
                <Box flex="1" textAlign="left" display="inline-block">
                  <Text fontWeight="bold">
                    {format(new Date(2021, 8, 1), "PPP")} -{" "}
                    {/* {format(new Date(2021, 4, 31), "PPP")} */}
                    Present
                  </Text>
                </Box>
                <AccordionIcon />
            ...
            <AccordionItem>
              ...
              <AccordionPanel pb={4}>
                <List>
                  <ListItem>
                    <Text display="inline-block" fontWeight="bold">
                      Mid Systems Developer{" "}
                    </Text>{" "}
                    @ Gaisano Unipace Corporation
                  </ListItem>
                </List>
              </AccordionPanel>
            </AccordionItem>
            ...
            <AccordionItem>
              <AccordionButton _expanded={{ bg: "blue.200", color: "black" }}>
                <Box flex="1" textAlign="left">
                  <Text fontWeight="bold">
                    {format(new Date(2019, 0, 16), "PPP")} -{" "}
                    {format(new Date(2019, 5, 30), "PPP")}{" "}
                  </Text>
                </Box>
                <AccordionIcon />
              </AccordionButton>
            ...
            <AccordionItem>
              <AccordionButton _expanded={{ bg: "blue.200", color: "black" }}>
                <Box flex="1" textAlign="left">
                  <Text fontWeight="bold">
                    {format(new Date(2018, 8, 1), "PPP")} -{" "}
                    {format(new Date(2019, 0, 15), "PPP")}{" "}
                  </Text>
                </Box>
                <AccordionIcon />
              </AccordionButton>
        ...
        <Stack>
          <Heading paddingTop="10">Tech Stack</Heading>
          <Accordion
          ...
          >
            ...
            <Tooltip
              hasArrow
              placement="auto"
              label="Can't code without my Jam."
